...
function stepHit(step:Int) {
    switch (step) {
        case 0:
            ...
            if (FlxG.save.data.bloom && Options.gameplayShaders) camGame.addShader(bloom);
        ...
        case 384:
            ...
            if (FlxG.save.data.bloom && Options.gameplayShaders) camGame.removeShader(bloom);
        case 1152:
        ...
        case 1408: // ! Stage Change
            ...
            snapCam();
            mobileControls.instance.buttonLeft.color = 0xFFFFFFFF;
            mobileControls.instance.buttonDown.color = 0xFFFFFFFF;
            mobileControls.instance.buttonUp.color = 0xFFFFFFFF;
