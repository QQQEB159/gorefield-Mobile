...
function postCreate() {
    mobileControls.instance.buttonLeft.color = 0xFFAEC340;
    mobileControls.instance.buttonDown.color = 0xFFAEC340;
    mobileControls.instance.buttonUp.color = 0xFFAEC340;
    mobileControls.instance.buttonRight.color = 0xFFAEC340;
}
