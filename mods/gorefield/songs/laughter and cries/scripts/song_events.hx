...
function postCreate() 
{
    ...
    mobileControls.instance.buttonLeft.color = 0xFF6772A8;
    mobileControls.instance.buttonDown.color = 0xFF6772A8;
    mobileControls.instance.buttonUp.color = 0xFF6772A8;
    mobileControls.instance.buttonRight.color = 0xFF6772A8;
}
