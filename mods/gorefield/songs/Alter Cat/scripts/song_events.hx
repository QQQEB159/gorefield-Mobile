...
//1.1 0.8 30
    ...
    if (FlxG.save.data.warp && Options.gameplayShaders) screamerCam.addShader(distortionShader);

    glitchShader = new CustomShader("glitch");
    glitchShader.glitchAmount = glitchAmount = 1;
    if (FlxG.save.data.glitch && Options.gameplayShaders) stage.stageSprites["jumpscare"].shader = glitchShader;
    ...
    mobileControls.instance.buttonLeft.color = 0xFF96331C;
    mobileControls.instance.buttonDown.color = 0xFF96331C;
    mobileControls.instance.buttonUp.color = 0xFF96331C;
    mobileControls.instance.buttonRight.color = 0xFF96331C;
}
