...
function create() 
{
    ...
    if (FlxG.save.data.heatwave && Options.gameplayShaders) rain.shader = heatWaveShader;
...
function postCreate()
{
    ...
    mobileControls.instance.buttonDown.color = 0xFF8B3536;
    mobileControls.instance.buttonUp.color = 0xFF8B3536;
